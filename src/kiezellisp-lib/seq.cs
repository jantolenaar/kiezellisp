...
namespace Kiezel
{
    public partial class Runtime
    {
        ...
        public static object Max( IEnumerable seq, params object[] args )
        {
            ...
            return ReduceSeq( reducer, seq, DefaultValue.Value, key );
        }
        ...
        {
            return AsLazyList( SeqBase.Remove( predicate, seq ) );
        }
        ...
        internal static Cons Map( KeyFunc func, params IEnumerable[] seqs )
        {
            return AsLazyList( SeqBase.Map( func, seqs ) );
        }

        internal static object ReduceSeq( Func<object, object, object> reducer, IEnumerable seq, object seed, IApply key )
        {
            var result = seed;
            foreach ( object x in ToIter( seq ) )
            {
