...
namespace Kiezel
{
    internal enum CompareClassResult
    {
        NotComparable,
        Equal,
        Less,
    ...
    internal class LambdaSignatureComparer : IComparer<LambdaSignature>
    {
    ...
    internal class MultiMethodApplyMetaObject : DynamicMetaObject
    {
